...
export default async function Page({ params }: { params: { courseId: string; chapterId: string } }) {
  ...
  return (
    <>
      {!chapter.isPublished && <Banner variant="warning" label="This chapter is not published yet. It will not be visible to students until it is published." />}
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="w-full">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <ChapterAction disabled={!isCompleted} courseId={params.courseId} chapterId={params.chapterId} isPublished={chapter.isPublished} />
            </div>
          </div>
        </div>
